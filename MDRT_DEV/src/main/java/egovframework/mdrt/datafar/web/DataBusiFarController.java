...
public class DataBusiFarController {
	
	
	
	@Resource(name = "DataBusiFarService")
	protected DataBusiFarService dataBusiFarService;
	
		
	@RequestMapping(value = "/dataBusiFar.json")
	public ModelAndView dataBusiFarData(HttpServletRequest request,HttpSession session, @RequestBody UserVo userSearch) throws Exception {
		ModelAndView modelAndView = new ModelAndView();
		try {
		
		List<UserVo> resultSummary = dataBusiFarService.getDataBusiFar(userSearch);           //사용자 조회
