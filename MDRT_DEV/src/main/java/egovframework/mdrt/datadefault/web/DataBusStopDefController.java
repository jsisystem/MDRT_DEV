...
public class DataBusStopDefController {
	
	
	
	@Resource(name = "DataBusStopDefService")
	protected DataBusStopDefService dataBusStopDefService;
	
		
	@RequestMapping(value = "/dataBusStopDef.json")
	public ModelAndView dataBusStopDefData(HttpServletRequest request,HttpSession session, @RequestBody UserVo userSearch) throws Exception {
		ModelAndView modelAndView = new ModelAndView();
		try {
		
		List<UserVo> resultSummary = dataBusStopDefService.getDataBusStopDef(userSearch);           //사용자 조회
