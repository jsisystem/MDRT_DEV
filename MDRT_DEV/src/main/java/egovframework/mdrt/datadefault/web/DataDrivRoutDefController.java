...
public class DataDrivRoutDefController {
	
	
	
	@Resource(name = "DataDrivRoutDefService")
	protected DataDrivRoutDefService dataDrivRoutDefService;
	
		
	@RequestMapping(value = "/dataDrivRoutDef.json")
	public ModelAndView dataDrivRoutDefData(HttpServletRequest request,HttpSession session, @RequestBody UserVo userSearch) throws Exception {
		ModelAndView modelAndView = new ModelAndView();
		try {
		
		List<UserVo> resultSummary = dataDrivRoutDefService.getDataDrivRoutDef(userSearch);  
